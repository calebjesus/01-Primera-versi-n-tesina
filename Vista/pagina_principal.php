...
<body style = "background-color: 	#f7f7ee">
    <nav class="nav nav-pills flex-column flex-sm-row" style="padding-bottom: 2px; padding-top: 2px;
    background-color:#be8560 " id="divPO">
    </nav>
    ...
    <script src="Herramientas/JS/navBarStyle.js"></script>
    <script>
